...
function Step4Page() {
  ...
  const handleDownloadStoryBible = async () => {
    try {
      const response = await fetch('http://localhost:5000/generate-story-bible-pdf', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          storyBible: storyBible,
          title: storyBible.title || 'Story Bible'
        }),
      });
      ...
      a.href = url;
      a.download = `${storyBible.title || 'Story_Bible'}.pdf`;
      document.body.appendChild(a);
      a.click();
      window.URL.revokeObjectURL(url);
      document.body.removeChild(a);
    } catch (error) {
      console.error('Error downloading story bible:', error);
      alert('Failed to download story bible. Please try again.');
    }
  };
          ...
          <div className="tab-content">
            ...
            <div className="story-details">
              ...
              <div className="right-stack">
                <div className="detail-item setting">
                  <h3>Setting</h3>
    ...
    <div className="step4-container">
      ...
      <div className="bible-container">
        ...
        <div className="action-buttons">
          ...
          <button className="generate-button" onClick={handleContinue}>
